...
public class EventRepositoryImpl implements EventRepository {
    ...
    private static final String SQL_CREATE = "INSERT INTO EVENTS(USER_ID, BUCKET_ID, STRESS_TYPE, DESCRIPTION, DATE_TIME, STRESS_LEVEL_CHANGE, RESULTING_STRESS_LEVEL) VALUES(?, ?, ?, ?, ?, ?, ?)";
