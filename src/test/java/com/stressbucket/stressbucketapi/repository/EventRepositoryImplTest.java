...
class EventRepositoryImplTest {
    ...
    public Event createEvent(){
        Clock clock = Clock.fixed(Instant.parse("2023-10-03T12:00:00.00Z"), ZoneId.of("GMT"));
        Event event = new Event(1, 1,1, "Stress Type", "Description", LocalDateTime.now(clock), 10, 60);
